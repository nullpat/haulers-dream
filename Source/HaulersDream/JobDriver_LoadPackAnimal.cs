...
namespace HaulersDream
{
    ...
    public class JobDriver_LoadPackAnimal : JobDriver
    {
        ...
        public override IEnumerable<Toil> MakeNewToils()
        {
            ...
            // The FILL walk, with a per-tick forbidden re-check (#250) — see SweepWalk. No forced-anchor
            ...
            Toil sweepGoto = SweepWalk.MakeToil(this, StackInd, "HD_Lpa_SweepGoto", sweepDecide,
                () => loadIndex++, () => false);
